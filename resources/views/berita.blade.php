    ...
    <section id="daftar-berita" class="py-20 bg-gray-50">
        <div class="max-w-7xl mx-auto px-10">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                @php
                $berita = [
                    ['id' => 1, 'img' => 'images/sanket-shah-SVA7TyHxojY-unsplash.jpg', 'title' => 'Lorem Ipsum', 'desc' => 'Sayuran.'],
                    ['id' => 2, 'img' => 'images/sebastian-coman-photography-eBmyH7oO5wY-unsplash.jpg', 'title' => 'GADO-GADO JAKARTA', 'desc' => 'Salad tradisional Indonesia dengan sayuran segar dan saus kacang.'],
                    ['id' => 3, 'img' => 'images/jimmy-dean-Jvw3pxgeiZw-unsplash.jpg', 'title' => 'RENDANG DAGING', 'desc' => 'Olahan daging sapi dengan rempah melimpah yang dimasak lama.'],
                    ['id' => 4, 'img' => 'images/luisa-brimble-HvXEbkcXjSk-unsplash.jpg', 'title' => 'SOTO LAMONGAN', 'desc' => 'Kuah kuning hangat yang kaya akan rempah, disajikan dengan koya.'],
                    ['id' => 5, 'img' => 'images/sanket-shah-SVA7TyHxojY-unsplash.jpg', 'title' => 'NASI GORENG JAWA', 'desc' => 'Hidangan ikonik dengan bumbu kecap manis dan terasi segar.'],
                    ['id' => 6, 'img' => 'images/sebastian-coman-photography-eBmyH7oO5wY-unsplash.jpg', 'title' => 'MIE ACEH PEDAS', 'desc' => 'Mie kuning tebal dengan bumbu kari pedas khas Serambi Mekkah.'],
                    ['id' => 7, 'img' => 'images/jimmy-dean-Jvw3pxgeiZw-unsplash.jpg', 'title' => 'AYAM BETUTU BALI', 'desc' => 'Hidangan khas Bali yang dimasak dengan bumbu genep melimpah.'],
                    ['id' => 8, 'img' => 'images/luisa-brimble-HvXEbkcXjSk-unsplash.jpg', 'title' => 'PEMPEK PALEMBANG', 'desc' => 'Olahan ikan tenggiri kenyal dengan kuah cuko pedas asam manis.'],
                ];
                @endphp
                ...
                @foreach($berita as $item)
                    ...
                    <div class="flex flex-col bg-white rounded-[35px] overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-500 card-hover h-full border border-gray-100">
                        <div class="h-52 overflow-hidden">
                            <img src="{{ asset($item['img']) }}" class="w-full h-full object-cover" alt="{{ $item['title'] }}">
                        </div>
                        ...
                        <div class="p-8 flex flex-col flex-grow text-left">
                            ...
                            @auth
                                {{-- Jika sudah Login: Tampilkan Tombol Modal --}}
                                <button type="button" 
                            ...
                            @else
                                ...
                                <a href="{{ route('login') }}" 
                                   class="text-amber-500 font-black text-[11px] uppercase tracking-widest hover:text-amber-700 transition">
                                    Baca Selengkapnya (Login Dulu)
                                </a>
                            @endauth
                        </div>
                    </div>

                    {{-- Modal Detail - Hanya dirender jika sudah login (lebih aman) --}}
                    @auth
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-centered">
                            <div class="modal-content rounded-[40px] border-none overflow-hidden shadow-2xl">
                                ...
                                <div class="modal-body p-0 text-left">
                                    <img src="{{ asset($item['img']) }}" class="w-full h-[400px] object-cover" alt="Detail">
